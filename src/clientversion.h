...
//! These need to be macros, as clientversion.cpp's and guardchain*-res.rc's voodoo requires it
...
/**
 * guardchaind-res.rc includes this file, but it cannot cope with real c++ code.
