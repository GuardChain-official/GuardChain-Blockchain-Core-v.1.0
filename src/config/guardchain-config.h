/* src/config/guardchain-config.h.  Generated from guardchain-config.h.in by configure.  */
/* src/config/guardchain-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The GuardChain Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "GuardChain Core"
...
#define PACKAGE_BUGREPORT "https://github.com/guardchainpay/guardchain/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GuardChain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GuardChain Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "guardchaincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://guardchain.org/"
