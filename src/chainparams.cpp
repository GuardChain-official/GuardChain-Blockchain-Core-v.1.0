 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1579896611, nBits=1e0ffff0, nNonce=692031, vtx=1)
...
{
    const char* pszTimestamp = "GuardChain x11 POW Masternode Blockchain 2020 ";
    const CScript genesisOutputScript = CScript() << ParseHex("04b33f24959c32e2d987ff47903d28ed875f814ccbcdbbb63216a639ea1b5066130ca7be51631a24a23c9bbeffdba1fc2031a2e5a7e344f03604d913e8d82ac2f2") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nBudgetPaymentsCycleBlocks = 4866.6666666667;
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock = 2; 
        consensus.nSuperblockStartHash = uint256();
        consensus.nSuperblockCycle = 4866.6666666667;
        ...
        consensus.defaultAssumeValid = uint256S("0x00000a395c536a4535d44053a1b2e6bd60bdc0a2f9e945911a07536cad48970a"); 
        ...
        vAlertPubKey = ParseHex("0469edf68c198a313f1399964e6684f954e79549f8d1ca6590a01f642636efd2a4a0de5e4eef0e437ef008aeedb552067e014031edf906b07c0779088ebf8194c9");
        nDefaultPort = 15744;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1579896611, 692031, 0x1e0ffff0, 1, 500 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000a395c536a4535d44053a1b2e6bd60bdc0a2f9e945911a07536cad48970a"));
        assert(genesis.hashMerkleRoot == uint256S("0x7249ef5536f94d4725027e8bf3c2fd8af31f85d82e446fa560cd607e28e42eeb"));


        vSeeds.push_back(CDNSSeedData("95.179.131.181", "95.179.131.181"));
        vSeeds.push_back(CDNSSeedData("209.250.245.213", "209.250.245.213"));
		vSeeds.push_back(CDNSSeedData("77.55.194.35", "77.55.194.35"));
        ...
        // GuardChain BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // GuardChain BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // GuardChain BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"GfVMyN6jkFBfjzyLH6RYwBfB6JHNuzw3oK"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000a395c536a4535d44053a1b2e6bd60bdc0a2f9e945911a07536cad48970a"))
        };

        chainTxData = ChainTxData{
            1579896611, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000c44ae76e86c44a9f6fe7b5087364ec1da934ede06a98ec4ba84c0267971"); 

        pchMessageStart[0] = 0xd1;
        pchMessageStart[1] = 0x8d;
        pchMessageStart[2] = 0xa8;
        pchMessageStart[3] = 0xa0;
        vAlertPubKey = ParseHex("044ec0cf0c9ffae74cb2df754e1edf9910ae154cdcf43b12afc32e5e8b709e9749adedda6e9630f4ca1217237772d15b0cecdbe27a1112313b2ccd74c2dd4c4fbc");
        nDefaultPort = 25744;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1579896616UL, 519285UL, 0x1e0ffff0, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000c44ae76e86c44a9f6fe7b5087364ec1da934ede06a98ec4ba84c0267971"));
        assert(genesis.hashMerkleRoot == uint256S("0x7249ef5536f94d4725027e8bf3c2fd8af31f85d82e446fa560cd607e28e42eeb"));
        ...
        // Testnet GuardChain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet GuardChain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet GuardChain BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"TWwZoCFgwhrNzQxD1N4PjD92sbEweyWvPU"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000c44ae76e86c44a9f6fe7b5087364ec1da934ede06a98ec4ba84c0267971"))
        };

        chainTxData = ChainTxData{
            1579896616, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1579896621, 0, 0x207fffff, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x70fffcc3fc14f11cca2b16083ef228d46b3d6caf41566914a34316eb2833fa1f"));
        assert(genesis.hashMerkleRoot == uint256S("0x7249ef5536f94d4725027e8bf3c2fd8af31f85d82e446fa560cd607e28e42eeb"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("guardchainevo.org",  "devnet-seed.guardchainevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x70fffcc3fc14f11cca2b16083ef228d46b3d6caf41566914a34316eb2833fa1f"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 7W3eqJVLZ6M8EvNNkyMSu85VUiJ3LhdX1XzGS7fz44hjWJK1AGP
        vSporkAddresses = {"TYZ6g5VX6vzfCwRwdSyVdyA4b1jaGft7j5"};
        nMinSporkKeys = 1;
        ...
        // Regtest GuardChain addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest GuardChain script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest GuardChain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest GuardChain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest GuardChain BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
