...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(), unit(BitcoinUnits::GUAC),
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("GUAC")
        updateDisplayUnit();
...
{
    QString link="https://bitcointalk.org/index.php?topic=5220598.0";
       QDesktopServices::openUrl(QUrl(link));
}

void OverviewPage::on_pushButton_2_clicked()
{
    QString link="https://github.com/GuardChain-official";
       QDesktopServices::openUrl(QUrl(link));
}

void OverviewPage::on_pushButton_3_clicked()
{
    QString link="https://twitter.com/GuardchainO";
       QDesktopServices::openUrl(QUrl(link));
}

void OverviewPage::on_pushButton_4_clicked()
{
    QString link="https://discord.gg/DxnWpVk";
       QDesktopServices::openUrl(QUrl(link));
}

void OverviewPage::on_pushButton_5_clicked()
{
    QString link="https://guardchain.info";
       QDesktopServices::openUrl(QUrl(link));
}
