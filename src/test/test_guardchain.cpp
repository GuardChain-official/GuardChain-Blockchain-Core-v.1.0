...
#define BOOST_TEST_MODULE GuardChain Test Suite

#include "test_guardchain.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_guardchain_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
