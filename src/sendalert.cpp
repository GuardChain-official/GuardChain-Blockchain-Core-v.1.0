...
2. run guardchaind with -printalert or -sendalert like this:
   /path/to/guardchaind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.guardchain.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/GuardChain Core:0.12.0.58/"));
