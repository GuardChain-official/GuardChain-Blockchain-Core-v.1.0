...
from test_framework.test_framework import GuardChainTestFramework
...
class LLMQCoinbaseCommitmentsTest(GuardChainTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as GuardChainTestFramework doesn't support this atm)
