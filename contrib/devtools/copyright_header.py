...
EXPECTED_HOLDER_NAMES = [
    ...
    "The GuardChain Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a GuardChain Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The GuardChain Core developers'
...
Arguments:
    <base_directory> - The base directory of GuardChain Core source code repository.
"""
...
Arguments:
    <file> - A source file in the GuardChain Core repository.
"""
