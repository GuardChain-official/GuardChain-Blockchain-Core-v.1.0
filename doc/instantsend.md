...
This mechanism has been integrated into Bitcore-Node-GuardChain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/guardchainpay/insight-api-guardchain#web-socket-api](https://github.com/guardchainpay/insight-api-guardchain#web-socket-api)
* API: [https://github.com/guardchainpay/insight-api-guardchain#instantsend-transactions](https://github.com/guardchainpay/insight-api-guardchain#instantsend-transactions)
